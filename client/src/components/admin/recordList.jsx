...
const Record = (props) => (
  <tr>
    ...
    <td>
      <Link id="button-generic" className="btn btn-outline-light" to={`/admin/edit/${props.record._id}`}>Edit</Link>
      <button id="button-generic" className="btn btn-outline-light"
        onClick={() => {
